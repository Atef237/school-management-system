    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('student.Deleted_Student_tilte')}}</h5>
...
{{--                    <input type="hidden" name="id" value="{{$student->id}}">--}}
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('student.Deleted_Student')}}</h5>
