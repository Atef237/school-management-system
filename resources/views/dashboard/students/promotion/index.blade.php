...
@section('pageInfo')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
            ...
            <li class="breadcrumb-item active"> {{trans('MainSidebar.students_promotion')}}</li>
        </ol>
    </div>
...
@section('title')
    {{trans('MainSidebar.students_promotion')}}
@endsection
                    ...
                    <form method="post" action="{{route('promotion.store')}}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="Classroom_id">{{trans('student.classrooms')}}: <span
                                        class="text-danger">*</span></label>
                                <select class="custom-select mr-sm-2" name="schooleYear_id_new" >
