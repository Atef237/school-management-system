...
@endif
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="col">
                        <label for="title">{{trans('addParent.Name_Mother')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('addParent.Name_Mother_en')}}</label>
                ...
                <div class="form-row">
                    <div class="col-md-3">
                        <label for="title">{{trans('addParent.Job_Mother')}}</label>
                    ...
                    <div class="col-md-3">
                        <label for="title">{{trans('addParent.Job_Mother_en')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('addParent.National_ID_Mother')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('addParent.Passport_ID_Mother')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('addParent.Phone_Mother')}}</label>
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">{{trans('addParent.Address_Mother')}}</label>
                ...
                @else
                    <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="button"
                            wire:click="secondStepSubmit">{{trans('addParent.Next')}}</button>
                @endif
