 ...
 @endif
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="col">
                        <label for="title">{{trans('addParent.Email')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('addParent.Password')}}</label>
                ...
                <div class="form-row">
                    <div class="col">
                        <label for="title">{{trans('addParent.Name_Father')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('addParent.Name_Father_en')}}</label>
                ...
                <div class="form-row">
                    <div class="col-md-3">
                        <label for="title">{{trans('addParent.Job_Father')}}</label>
                    ...
                    <div class="col-md-3">
                        <label for="title">{{trans('addParent.Job_Father_en')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('addParent.National_ID_Father')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('addParent.Passport_ID_Father')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('addParent.Phone_Father')}}</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputCity">{{trans('addParent.Nationality_Father_id')}}</label>
                        <select class="custom-select my-1 mr-sm-2" wire:model="Nationality_Father_id">
                            <option selected>{{trans('addParent.Choose')}}...</option>
                    ...
                    <div class="form-group col">
                        <label for="inputState">{{trans('addParent.Blood_Type_Father_id')}}</label>
                    ...
                    <div class="form-group col">
                        <label for="inputZip">{{trans('addParent.Religion_Father_id')}}</label>
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">{{trans('addParent.Address_Father')}}</label>
                ...
                @if($updateMode)
                    <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" wire:click="firstStepSubmit_edit"
                            type="button">{{trans('addParent.Next')}}
                    </button>
                @else
